...
import { SerializedEventPayload } from '../../../domain/interfaces/serializable-event';
...
export class EventSerializer {
  serialize<T extends object>(
    ...
    return {
      ...
      position: dispatcher.verion.value + 1,
      type: eventType,
      data: this.toJSON(event) as SerializedEventPayload<T>,
    };
  }

  private toJSON<T>(data: T): unknown {
